...
interface LagrangePolynomialChartProps {
...
export function LagrangeErrorChart({
  training_points,
  validation_points,
  coefficients,
  domain,
}: LagrangePolynomialChartProps) {
  ...
  // Coeficientes en orden descendente: an*x^n + an-1*x^(n-1) + ... + a1*x + a0
