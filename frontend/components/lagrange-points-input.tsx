...
interface LagrangePointsInputProps {
...
export function LagrangePointsInput({ 
  points, 
    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-2 items-center" style={{ gridTemplateColumns: `repeat(${points.length}, minmax(0, 1fr))` }}>
            {points.map((_, index) => (
              <div key={`delete-${index}`} className="flex justify-center">
                <Button
                  variant="ghost"
                  size="sm"
        ...
        {/* Add Point Button */}
        <Button onClick={handleAddPoint} disabled={points.length >= 20} variant="outline" className="w-full">
